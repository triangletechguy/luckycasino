...
export function RainMoney() {
    const delay = [1.1, 0.8, 0, 0.6, 0.4, 0, 0.7, 0,
        0.3, 0.6, 0.5, 0.3, 0.4, 1,
        0.4, 0.3, 0, 1.5, 0, 1.3, 0.5, 0,
        0.6, 0.4, 1.6, 0.3, 1.3, 2,
        0.6, 0.7, 0.4, 1.7, 2.3, 0,
        0.6, 0.3, 0.6, 0.5, 0.8, 2,
        1.6, 2.5, 1.3, 1.4, 1.6,
        2.6, 1.5, 2.3, 1.4, 1.4,
        2.6, 2.5, 2.3, 2.4, 1.2,
        2.6, 1.5, 2.3, 2.4, 2.9,
        ...
        <>
            {
                duration.map((index, i) => (<motion.img
                    ...
                    animate={{
                        x: [positionXStart[i], 0 - positionXEnd1[i],],
                        y: [positionYStart[i] + 100, positionYMiddle[i] + 70, positionYEnd[i] + 12],   // rise then drop
                        rotateX: [0, rotateX[i]],
                        rotateY: [0, rotateY[i]],
                        rotateZ: [0, rotateZ[i]],    // spin
                    }}
            ...
            }
            {
                duration1.map((index, i) => (<motion.img
                    ...
                    animate={{
                        x: [positionXStart1[i] - 450, positionXEnd1[i],],
                        y: [positionYStart1[i] + 100, positionYMiddle1[i] + 70, positionYEnd1[i] + 12],   // rise then drop
                        rotateX: [0, rotateX1[i]],
                        rotateY: [0, rotateY1[i]],
                        rotateZ: [0, rotateZ1[i]],    // spin
                    }}
...
export function ResultPending({ status, }: { status: number[], }) {
    ...
    let index3 = -1
    let index4 = -1
    if (status[0] === status[4] && status[8] === status[4]) {
        index0 = total
        total += 1
    }
    if (status[6] === status[4] && status[2] === status[4]) {
        index1 = total
        total += 1
    }
    ...
    if (status[3] === status[4] && status[5] === status[4]) {
        index3 = total
        total += 1
    }
    if (status[6] === status[7] && status[8] === status[7]) {
        index4 = total
        total += 1
    }
    useEffect(() => {
